...
class UNet(nn.Module):
    def __init__(self, bilinear=False, class_num=8):
        super(UNet, self).__init__()
        self.bilinear = bilinear

        self.inc = nn.Conv2d(3, 64, kernel_size=9, stride=1, padding=4, bias=False)
        ...
        self.bn = torch.nn.GroupNorm(num_groups=8, num_channels=32)
        self.conv1 = nn.Conv2d(64, 32, kernel_size=1)
        self.conv2 = nn.Conv2d(32, class_num, kernel_size=1)
